    ...
    <ScrollView style = {styles.container}>
      ...
      <Text style = {styles.title}> 해외여행을 위한 적금 챌린지{"\n"}✈더 넓은 세상으로✈</Text>
        ...
        <View>
          ...
          매달 조금씩 적금을 넣기 시작한다면,{"\n"}여행을 위한 경비를 마련하는 데 큰 도움이 될 것입니다.{"\n"}{"\n"}
          이 챌린지는 해외여행 경비 마련을 통해 여러분이 꿈을 향한 첫 걸음을 내딛 데 도움을 주는 특별한 챌린지입니다. {"\n"}함께 해외여행을 위한 적금 챌린지에 참여하여 여러분의 꿈을 이루는 여정을 시작해보세요.{"\n"}
          </Text>
        </View>
        ...
        <Text style = {styles.text_bold}>1️⃣ 목표 설정:{"\n"}</Text>목표는 매달 정해진 금액을 적금으로 저축하여 해외여행을 위한 경비를 마련하는 것입니다. 여행 일정과 필요한 금액을 고려하여 목표 금액과 저축 기간을 설정해보세요.{"\n"}{"\n"}
        <Text style = {styles.text_bold}>2️⃣ 적금 개설:{"\n"}</Text>하단의 챌린지 참여하기 버튼을 통해 적금 계좌를 개설하고, 매달 정해진 금액을 저축하도록 계획을 세워보세요. {"\n"}{"\n"}
        <Text style = {styles.text_bold}>3️⃣ 정기 점검:{"\n"}</Text>매달 저축한 금액을 확인하고, 목표에 도달하기 위해 얼마나 더 노력해야 하는지 정기적으로 점검해보세요. {"\n"}{"\n"}
        <Text style = {styles.text_bold}>4️⃣ FINN WISH:{"\n"}</Text>행복한 해외여행을 다녀와 챌린지를 성공적으로 마무리해 보세요! {"\n"}{"\n"}
        </Text>

        <Text style = {styles.small_title}>🍀Why Join? </Text>
        <Text style = {styles.text2}>
          ✅ 저축 역량: 적금 챌린지를 통해 자신의 돈을 효과적으로 저축하는 방법을 배울 수 있습니다. 이는 여행을 위한 저축을 비롯하여 삶의 다양한 영역에서 도움이 될 것입니다. {"\n"}{"\n"}
          ✅ 자금 조달: 적금 챌린지를 통해 매달 조금씩 저축하여 해외여행이란 더 넓은 식견을 가지기 위한 자금을 조달할 수 있습니다.
        </Text>
        ...
        해외여행을 위한 적금 챌린지에 참여하여 꿈을 향한 첫 걸음을 내딛어보세요. 매달 조금씩 저축하여 여행 경비를 마련해 새로운 경험과 추억을 만들어보세요.{"\n"}챌린지에 참여하여 여러분의 꿈을 이루는 여정에 함께할 준비가 되셨나요?
        </Text>
        </View>
    </ScrollView>
  )
